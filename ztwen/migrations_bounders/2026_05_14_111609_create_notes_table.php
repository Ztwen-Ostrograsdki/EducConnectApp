...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('notes', function (Blueprint $table) {
            ...
            $table->decimal('valeur', 5, 2);                    // valeur de la note
            $table->decimal('sur', 5, 2)->default(20);          // sur combien (10 ou 20)
            $table->text('commentaire')->nullable();
            $table->boolean('est_editable')->default(true);     // devient false après délai
