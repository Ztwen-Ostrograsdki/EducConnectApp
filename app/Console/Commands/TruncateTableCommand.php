...
#[Signature('truncate:table {table_name}', ['vider:table {table_name}', 'empty:table {table_name}', 'clear:table {table_name}'])]
#[Description('Opération rafraîchissement (Truncatage) de table dans la base de donées')]
class TruncateTableCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if($table_name){
            ...
            if(Schema::hasTable($table_name)){
                ...
                $this->warn("⚠️ Toutes les données de la table " . $table_name . " seront éffacées. Continuer ? (yes/no)");
    ...
    public function clearData(string $table_name)
    {
        try {
