...
class ClassesPrintableDocumentsPage extends Component
{
    ...
    public function mount(?string $filiar_slug = null, ?string $promotion_slug = null, ?string $promotionsGrouped = null, ?string $serial_slug = null)
    {
        self::initiator($filiar_slug, $promotion_slug, $promotionsGrouped, $serial_slug);
    }
