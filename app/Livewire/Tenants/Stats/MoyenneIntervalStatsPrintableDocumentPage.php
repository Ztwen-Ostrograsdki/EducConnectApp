...
#[Title('Statistiques périodiques des classes')]
class MoyenneIntervalStatsPrintableDocumentPage extends Component
{
    ...
    public string $pageTitle = 'Documents générés - Les statistiques';
    ...
    {
        return GeneratedDocument::ofType('moyenne_stats_list')
    ...
    {
        return view('livewire.tenants.stats.moyenne-interval-stats-printable-document-page');
    }
}