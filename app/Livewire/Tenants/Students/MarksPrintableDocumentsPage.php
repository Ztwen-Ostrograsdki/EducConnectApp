...
#[Title('Gestion des fichiers de notes générés sur les apprenants')]
class MarksPrintableDocumentsPage extends Component
{
    ...
    public string $targetRoute = 'tenant.notes.docs';
    
    public string $pageTitle = 'Documents générés - Liste des fichiers de notes';

    public $targetRoutes = [
        'tenant.notes.docs' => 'Liste des fichiers de notes apprenants',
    ];
    ...
    {
        return GeneratedDocument::ofType('marks_list')
    ...
    {
        return view('livewire.tenants.students.marks-printable-documents-page');
    }
}