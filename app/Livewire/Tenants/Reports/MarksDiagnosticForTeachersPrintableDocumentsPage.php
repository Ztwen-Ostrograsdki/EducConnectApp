...
class MarksDiagnosticForTeachersPrintableDocumentsPage extends Component
{
    ...
    public string $pageTitle = 'Documents générés - Rapports notes effectuées ';

    public $targetRoutes = [
        'tenant.students.docs' => 'Liste des apprenants',
        'tenant.classes.docs' => 'Liste des classes',
    ...
    {
        return GeneratedDocument::ofType('marks_diagnostic_list')
    ...
    public function initiator(?string $filiar_slug = null, ?string $promotion_slug = null, ?string $promotionsGrouped = null, ?string $serial_slug = null)
    {
        if($filiar_slug){
    ...
    {
        return view('livewire.tenants.reports.marks-diagnostic-for-teachers-printable-documents-page');
    }
}
