...
@section('content')
    <div class="relative min-h-screen flex items-center justify-center px-6">
        ...
        <div class="fixed inset-0 flex items-center justify-center pointer-events-none select-none">
            <span class="font-mono text-[28vw] font-medium text-white leading-none tracking-tighter animate-float-code"
                style="opacity:0.04">403</span>
        </div>

        {{-- Red ambient glow --}}
        <div class="fixed pointer-events-none"
            style="top:30%;left:50%;transform:translate(-50%,-50%);width:600px;height:400px;background:radial-gradient(ellipse,rgba(248,113,113,0.08) 0%,transparent 70%)">
        </div>
        ...
        <div class="relative z-10 text-center max-w-lg">
            ...
            <div class="opacity-0-init animate-fade-up mb-8 flex justify-center">
                <div class="relative">
                    ...
                    <div class="relative w-16 h-16 rounded-2xl flex items-center justify-center lock-shake"
            ...
            {{-- Badge --}}
            <div class="opacity-0-init animate-fade-up mb-6 inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-mono"
            ...
            @if (isset($exception) && $exception->getMessage())
                <div class="opacity-0-init animate-fade-up-delay2 font-mono text-xs px-4 py-3 rounded-lg mb-8 text-left mx-auto max-w-sm"
            ...
            <div class="opacity-0-init animate-fade-up-delay3 flex flex-col sm:flex-row gap-3 justify-center">
                <a href="{{ url('/') }}"
                    class="btn-secondary inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium">
                ...
                @guest
                    <a href="{{ route('login') }}"
                        class="btn-primary inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
