        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="flex justify-between items-center p-6 border-b border-slate-700">
                ...
                <button wire:click="closeBatchModal"
                    class="h-10 w-10 rounded-2xl bg-slate-800 hover:bg-slate-700 transition-colors flex items-center justify-center active:scale-95">
                        ...
                        <div class="flex gap-3 mt-6">
                            @if ($task->status === 'failed')
                                <button wire:click="retryOne({{ $task->id }})" wire:loading.attr="disabled"
                                    ...
                                    class="px-5 py-2.5 rounded-2xl bg-amber-500 hover:bg-amber-600 text-black text-sm font-medium transition-all active:scale-95">
                                    <span wire:loading.remove
                            ...
                            <button wire:click="deleteOne({{ $task->id }})" wire:loading.attr="disabled"
                                ...
                                class="px-5 py-2.5 rounded-2xl bg-rose-600 hover:bg-rose-700 text-white text-sm font-medium transition-all active:scale-95">
                                <span wire:loading.remove
