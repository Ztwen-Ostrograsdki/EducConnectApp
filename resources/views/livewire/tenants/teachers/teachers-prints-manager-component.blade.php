<div x-data="{ showColumnsHint: false }">
    <div class="mb-20 p-2 relative">
        ...
        <section
            ...
            <h4 class="text-lg font-bold ls-1 border-b border-b-slate-600 py-2 text-indigo-700">
                Cibler les enseignants à imprimer
            </h4>
        ...
        {{-- ═══ STATUTS SPÉCIFIQUES ENSEIGNANTS ═══ --}}
        <section
            class="rounded-2xl p-3 bg-indigo-900/10 border border-indigo-900 overflow-hidden flex flex-col gap-3 mb-3">
            <h4 class="text-lg font-bold ls-1 border-b border-b-slate-600 py-2 text-indigo-700">
                Cibler le statut des enseignants à imprimer
            </h4>

            <div class="grid grid-cols-3 items-center gap-3 w-full font-mono text-slate-500">
                <select wire:model.live='trashedStatus'
                    class="py-3 px-3 rounded-2xl bg-slate-950 border border-slate-800 text-sm transition-colors focus:border-indigo-500">
        ...
        <section class="my-2 border border-slate-700 rounded-2xl p-3 flex flex-col gap-2">
            ...
            <div class="flex justify-start items-center text-xl text-slate-600 font-mono">
                <span>Enregistrements trouvés : {{ __zero($this->allTeachersCounter) }}</span>
            </div>
        </section>
        ...
        <section class="my-2 border border-slate-700 rounded-2xl p-3 flex flex-col gap-2">
            ...
            <p
                class="text-center text-slate-600 text-sm font-mono mt-2 animate-pulse border-t border-t-slate-700 py-3">
        ...
        <button title="Lancer la procédure d'impression" wire:click="initPrintProcess" wire:loading.attr="disabled"
            ...
            <span wire:loading.remove wire:target="initPrintProcess"
                ...
                <span class="text-xs">({{ __zero($this->allTeachersCounter) }} enregistrements seront imprimés)</span>
            </span>
