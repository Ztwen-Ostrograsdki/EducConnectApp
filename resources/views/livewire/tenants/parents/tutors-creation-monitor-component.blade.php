<div class="w-full mx-auto max-w-7xl border border-slate-700 rounded-3xl p-6 bg-slate-950/50">
    ...
    <section class="bg-slate-900/80 backdrop-blur-2xl rounded-3xl p-6 mb-8 shadow-xl border border-slate-700/50">
            ...
            <div class="flex items-center gap-5">
                ...
                <div>
                    ...
                    <p class="text-slate-400 text-sm mt-1">
                        Gestion des migrations des tuteurs
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap gap-3 mt-6">
            <a wire:navigate href="{{ route('tenant.parents.create') }}"
                class="p-2 rounded-2xl bg-indigo-600 hover:bg-indigo-800 transition-all active:scale-95 font-medium gap-2 inline-flex items-center">
    ...
    @if ($batches->isEmpty())
        <div class="bg-slate-900/70 border border-slate-700 rounded-3xl p-16 text-center">
            ...
            <p class="text-slate-400 text-lg">Aucune tâche de migration | Création des tuteurs trouvée</p>
        </div>
    @else
                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                <h2 class="font-bold text-lg text-white">Import tuteurs</h2>
