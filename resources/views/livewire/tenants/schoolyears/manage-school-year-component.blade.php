<div class="min-h-screen bg-[#070b14] text-slate-100 p-4 sm:p-6">
    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <section
            ...
            <div class="relative flex items-start gap-4">
                <div
                    ...
                    <x-lucide-calendar-cog class="h-7 w-7 text-indigo-400" />
                </div>
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        <span class="font-medium text-indigo-300">{{ $schoolYear }}</span>
                        · Ajustez les périodes et les dates
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="rounded-2xl border border-white/[0.06] bg-[#0f1523] p-5 sm:p-6 shadow-lg shadow-black/10">
                <div class="mb-5 flex items-center gap-3 border-b border-white/[0.05] pb-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Année et type de périodes</p>
                    </div>
                </div>
        ...
        <button type="button" wire:click="update" wire:loading.attr="disabled"
            ...
            <span wire:loading.remove wire:target="update" class="relative inline-flex items-center gap-2">
                <x-lucide-save class="h-4.5 w-4.5" />
                Enregistrer les modifications
            </span>
            <span wire:loading wire:target="update" class="relative inline-flex items-center gap-2">
