<div class="w-full overflow-x-hidden">
    ...
    <div class="mx-auto w-full max-w-[1900px] px-3 sm:px-4 lg:px-6 xl:px-8">
        ...
        <section class="my-4 mb-5 border-y border-y-slate-800 py-4">
            <div class="grid grid-cols-1 lg:grid-cols-7 gap-3 items-center text-center">
                ...
                <button
                    ...
                    class="relative py-4 px-5 rounded-2xl text-white {{ $filiar->deleted_at ? 'bg-green-600/50 hover:bg-green-800/80' : 'bg-red-500/60 hover:bg-red-600/80' }} text-xs font-medium inline-flex items-center justify-center gap-1.5  rounded-2xl transition-all whitespace-nowrap disabled:opacity-50 hover:text-black">
