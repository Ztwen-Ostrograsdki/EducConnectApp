<div class="mx-auto w-full space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Edition de la classe</h1>
            <p class="text-sm text-slate-500 mt-0.5">Modification des infos de classe : année scolaire
    ...
    <div class="flex justify-end gap-3">
        ...
        <button wire:click="save" wire:loading.attr="disabled"
            ...
            <span wire:loading.remove wire:target="save">
                <x-lucide-check class="w-4 h-4 inline -mt-0.5" /> Sauvegarder
            </span>
