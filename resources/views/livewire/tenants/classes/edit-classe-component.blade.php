{{-- resources/views/livewire/classe/edit.blade.php --}}
<div class="mx-auto max-w-3xl space-y-6">

    {{-- Header --}}
    <div class="flex items-center gap-4">
        <a href="{{ route('tenant.classe.profil', ['classe_slug' => $classe_slug]) }}" wire:navigate
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-0.5">{{ $classe->name }}</p>
        </div>
    </div>
