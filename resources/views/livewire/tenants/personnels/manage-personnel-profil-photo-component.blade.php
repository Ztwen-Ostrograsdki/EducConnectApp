<div x-data class="w-full max-w-7xl mx-auto py-8">
    ...
    @if ($model)
        <form wire:submit="save">
            ...
            <div class="overflow-hidden rounded-3xl border border-white/10 bg-slate-900/80 backdrop-blur-xl shadow-2xl">
                ...
                <div class="relative h-72 overflow-hidden">
                    ...
                    <div wire:loading.flex wire:target="photo"
                        ...
                        <div class="text-center">
                            ...
                            <svg class="w-10 h-10 animate-spin text-cyan-400 mx-auto" fill="none"
                                viewBox="0 0 24 24">
                    ...
                    <div class="flex flex-col lg:flex-row
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-slate-400 mt-1">
                                Personnalisez la photo de profil du personnel {{ $model->getFullName() }}
                            </p>
                            <p class="uppercase text-slate-500">
                                Poste : {{ $model->title }}
                            </p>
