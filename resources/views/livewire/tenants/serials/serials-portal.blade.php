    ...
    <div class="mx-auto
        ...
        <section class="mb-6">
            ...
            <div class="grid
                ...
                @foreach ([['Séries', '7', 'text-indigo-400'], ['Classes', '124', 'text-sky-400'], ['Apprenants', '4 812', 'text-emerald-400'], ['Moyenne Générale', '12.84', 'text-amber-400'], ['Taux Réussite', '78%', 'text-violet-400']] as $kpi)
                                ...
                                <tr class="hover:bg-slate-800/40
                                    ...
                                    <td class="px-6 py-5">
                                        ...
                                        <div class="flex justify-end
                                            ...
                                            {{-- PROFIL --}}
                                            <a href="{{ route('tenant.serial.profil', ['serial_slug' => 'f']) }}" class="p-2.5 rounded-2xl bg-blue-500/20 text-blue-400  hover:bg-blue-500/30 transition-all text-sm inline-block text-center">
                                                Profil
                                            </a>
