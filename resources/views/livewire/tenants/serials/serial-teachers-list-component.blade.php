<section class="mb-6 p-2 relative" x-data="{ open: true }">
    ...
    <div class="rounded-tl-2xl rounded-tr-2xl bg-indigo-900/10 border border-indigo-900 overflow-hidden">
        ...
        <div type="button" @click="open = !open"
            class="w-full text-left p-5 border-b border-slate-800 flex flex-col gap-4 cursor-pointer">
            <div>
        ...
        <div x-show="open" x-collapse x-transition:enter="transition ease-out duration-300"
            ...
            @livewire('tenants.components.teachers-lister-component', ['serial_id' => $this->serial->id, 'serial' => $this->serial, 'teachers_promotion_id' => $teachers_promotion_id, 'teachers_gender' => $teachers_gender, 'teachers_classe_id' => $teachers_classe_id])
        </div>
