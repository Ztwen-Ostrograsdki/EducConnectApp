<section class="mb-6 relative" x-data="{ open: true }">
    ...
    <div class="rounded-tl-2xl rounded-tr-2xl bg-purple-900/15 border border-purple-800 overflow-hidden">
        <div type="button" @click="open = !open"
            class="w-full text-left p-5 sm:p-6 border-b border-slate-800 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-5 cursor-pointer">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-400">Gestion des apprenants de la série selon les
