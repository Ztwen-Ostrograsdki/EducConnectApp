            ...
            @foreach ($this->tenants as $tenant)
                ...
                <div wire:key="tenant-{{ $tenant->id }}"
                    ...
                    <div class="relative p-5 sm:p-6">
                        ...
                        {{-- SCHOOL --}}
                        <a wire:navigate href="{{ route('central.school.profil', ['school' => $tenant->id]) }}"
                            ...
                            <div class="flex items-center gap-4 min-w-0">
                                ...
                                <div class="min-w-0 group">
                                    <h3
                                        class="text-lg font-bold truncate hover:underline underline-offset-2 hover:text-sky-600">
                                        {{ $tenant->school_name }}
                                    </h3>
                                    <p class="text-sm text-slate-400 truncate">

                                        Ecole {{ $tenant->school_type }}
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div
                                    class="w-12 h-12 rounded-2xl
                                       bg-slate-900
                                       flex items-center justify-center border border-sky-400">
                        ...
                        @if ($activeSubscription)
                            ...
                            <div
                               ...
                               bg-sky-500/5 p-4 animate-pulse">
                        ...
                        @else
                            <div
                               ...
                               bg-red-500/5 p-4 animate-pulse">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    ...
                                    <div
                                       ...
                                       flex items-center justify-center">
                                        ...
                                        <x-lucide-crown class="w-6 h-6 text-red-400" />
