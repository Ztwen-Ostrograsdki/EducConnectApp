    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="s-nav">
            ...
            <div class="s-section">
                ...
                <a data-sidebar-item href="#" class="s-link"><div class="s-icon">📚</div><span class="s-label">Matières</span></a>
                <a data-sidebar-item href="#" class="s-link"><div class="s-icon">🎯</div><span class="s-label">Promotions</span></a>
                <a data-sidebar-item href="#" class="s-link"><div class="s-icon">🗓️</div><span class="s-label">Emploi du temps</span></a>
            </div>
