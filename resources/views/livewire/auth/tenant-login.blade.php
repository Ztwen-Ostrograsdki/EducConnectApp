<div
    class="min-h-screen flex items-center justify-center bg-sky-950 px-4"
    x-data
    x-init="
        $nextTick(() => {
    ...
    "
>
    <div class="login-card w-full max-w-md bg-gray-950 rounded-2xl shadow-sm border border-sky-500 p-8">
